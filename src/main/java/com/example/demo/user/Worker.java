...
public class Worker {
    ...
    public Worker(String bio, String displayName, String gender, String githubUsername, String location, String nationality, double preferredAnnualPay, double preferredMonthlyPay, String residence, String skills, String username, String website) {
        this.bio = bio;
